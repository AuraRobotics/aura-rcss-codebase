...
rcsc::PlayerPtrCont &CafeModel::getPlayerInRangeX(int x1, int x2, bool ourTeam) {
    if (ourTeam == true) {
...
rcsc::PlayerPtrCont &CafeModel::getPlayerInRangeX(const rcsc::PlayerPtrCont player, int x1, int x2) {
